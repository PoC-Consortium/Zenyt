...
*   Usage limited to specific blockchains
...
PoCC Jantar A Zenyt Wallet - Terms and conditions
--------------------------------------------------

1. **Preamble:** This Agreement governs the relationship between the operator of this software, (hereinafter: Licensee) and PoC Consortium, a partnership under the laws of whose principal place of business is Germany (hereinafter: Licensor). This Agreement sets the terms, rights, restrictions and obligations on using Jantar back-end (hereinafter: The Software) created and owned by Licensor, as detailed herein

2. **Restricted Use:**

Use of The Software is granted to provide access to and interaction with the public ledger (blockchain) of the Zenyt cryptocurrency (ZENYT) network only. Licensee must adhere to the majority consensus of the Zenyt network.

More specifically, it is prohibited to use The Software for any other blockchain whose tokens are traded on any exchange (public, restricted or private) under a different ticker symbol than ZENYT.

Licensee is allowed to use The Software on the public Zenyt network (MainNet), the Zenyt test network (TestNet) or a private version of the Zenyt network running on and accessible from his local machine only (PrivNet).
